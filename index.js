...
function MenuElemaniOlustur(ad, ucret, sinif /*Kodlar buraya*/) {
  const yeniEleman = { isim: ad, fiyat: ucret, kategori: sinif };
  return yeniEleman;
  /*Kodlar buraya*/
}
...
console.log(MenuElemaniOlustur("Iskender", 10, "Dönerler"));
console.log(MenuElemaniOlustur("Baklava", 10, "Tatlilar"));
/* Görev 2: 
